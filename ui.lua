...
-- Edited Version by ERSENTEKIN !! Please pay attention, this is not the legal version!
-- I edited ui.lua v1.5 because I've got some runtime errors. So , I just added newImageRect property to the module.
...
function newButton( params )
        ...
        local button, default , defaultX , defaultY , over , overX , overY , size, font, textColor, offset, isActive
        ...
        if params.disabled then
                disabled = display.newImageRect( params.disabled ,  params.overX , params.overY)
